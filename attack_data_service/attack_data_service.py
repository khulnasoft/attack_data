...
def main(args):
    ...
    parser.add_argument("-arr", "--attack_range_repo", required=False, default="khulnasoft/attack_range",
    ...
    parser.add_argument("-adr", "--attack_data_repo", required=False, default="khulnasoft/attack_data",
    ...
    parser.add_argument("-artr", "--atomic_red_team_repo", required=False, default="khulnasoft",
                        help="specify the url of the attack data repository")
    ...
    filedata = filedata.replace('art_repository = khulnasoft', 'art_repository = ' + atomic_red_team_repo)
    ...
    if not execution_error:
        ...
        for file in onlyfiles:
            dataset_urls.append('https://media.githubusercontent.com/media/khulnasoft/attack_data/master/datasets/attack_techniques/' + simulation_technique +  '/atomic_red_team/' + file)
        ...
        os.system('git config --global user.email "research@khulnasoft.com"')
        ...
        repo = g.get_repo("khulnasoft/attack_data")
